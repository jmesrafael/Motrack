...
export const fil: DeepPartial<typeof en> = {
  onboarding: {
    ...
    language: {
      ...
      body: 'Piliin kung anong wika ang gagamitin mo sa Motrack. Puwede mo pa rin itong baguhin anumang oras sa Settings.',
      english: 'English',
  ...
  help: {
    ...
    maintenanceDates: {
      ...
      whenBody: 'I-log agad ang ginawang maintenance, tulad ng oil change o bagong brake pads. Gagamitin ng Motrack ang petsa at odometer reading na iyon para malaman kung kailan ang susunod.',
      ...
      intervalsBody: 'May recommended interval ang bawat component, sa kilometro, buwan, o pareho. Bibilangin ito ng Motrack mula sa huli mong log para malaman mo kung kailan ito magiging due.',
      remindersTitle: 'Paano ginagamit ito ng reminders',
      remindersBody: 'Kapag malapit nang mag-due o overdue na ang isang component, lalabas ito sa dashboard mo at puwede kang bigyan ng Motrack ng reminder. Mas tumpak ang mga estimate na ito kapag updated ang odometer mo.',
    },
  },
};
